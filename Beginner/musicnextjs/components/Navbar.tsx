...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "fixed top-5 md:top-10 inset-x-0 z-100 px-4 md:px-0",
        className,
      )}
    >
      {/* ================= DESKTOP ================= */}
      ...
      {/* ================= MOBILE ================= */}
      <div className="md:hidden flex flex-col items-center relative z-100">
        {/* Menu Button */}
        <button
          type="button"
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="relative z-100 mt-3 w-[calc(100vw-2rem)] max-w-sm overflow-hidden rounded-2xl bg-[#222222] text-white shadow-xl">
            <div className="flex flex-col px-6 py-5">
              ...
              <button
                type="button"
                onClick={() =>
                  setActive(active === "Our Courses" ? null : "Our Courses")
                }
              ...
              {active === "Our Courses" && (
                <div className="flex flex-col space-y-4 border-l border-white/20 pl-4 pb-3">
                  <HoveredLink href="/course" onClick={closeMobileMenu}>
                    All Courses
                  </HoveredLink>

                  <HoveredLink href="/#" onClick={closeMobileMenu}>
                    Basic Music Theory
                  </HoveredLink>
